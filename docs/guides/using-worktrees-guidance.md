...
- **Example iOS and macOS use Swift Package Manager**, not CocoaPods. Do not run `pod install`. The first `flutter run` in `example/` generates the ephemeral Swift package.
