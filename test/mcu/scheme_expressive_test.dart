...
void main() {
  test('keyColors', () {
    ...
    expect(MaterialDynamicColors.primaryPaletteKeyColor.getArgb(scheme), isColor(0xff35855f));
    expect(MaterialDynamicColors.secondaryPaletteKeyColor.getArgb(scheme), isColor(0xff8c6d8c));
    expect(MaterialDynamicColors.tertiaryPaletteKeyColor.getArgb(scheme), isColor(0xff806ea1));
    expect(MaterialDynamicColors.neutralPaletteKeyColor.getArgb(scheme), isColor(0xff79757f));
    expect(MaterialDynamicColors.neutralVariantPaletteKeyColor.getArgb(scheme), isColor(0xff7a7585));
  });
  ...
  test('lightTheme_minContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xff99eabd));
  });
  ...
  test('lightTheme_standardContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xffa2f4c6));
  });
  ...
  test('lightTheme_maxContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xff005436));
  });
  ...
  test('lightTheme_minContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xff388862));
  });
  ...
  test('lightTheme_standardContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xff005234));
  });
  ...
  test('lightTheme_standardContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xff002112));
  });
  ...
  test('darkTheme_minContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xff00432a));
  });
  ...
  test('darkTheme_standardContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xff005234));
  });
  ...
  test('darkTheme_maxContrast_primaryContainer', () {
    ...
    expect(MaterialDynamicColors.primaryContainer.getArgb(scheme), isColor(0xff83D3A8));
  });
  ...
  test('darkTheme_minContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xff43936C));
  });
  ...
  test('darkTheme_standardContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xffa2f4c6));
  });
  ...
  test('darkTheme_maxContrast_onPrimaryContainer', () {
    ...
    expect(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme), isColor(0xff000E06));
  });
