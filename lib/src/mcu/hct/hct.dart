...
class Hct {
  ...
  Hct inViewingConditions(ViewingConditions vc) {
    ...
    final Cam16 cam16 = Cam16.fromInt(toInt());
    final List<double> viewedInVc = cam16.xyzInViewingConditions(vc);

    // 2. Create CAM16 of those XYZ coordinates in default VC.
    final Cam16 recastInVc = Cam16.fromXyzInViewingConditions(
      viewedInVc[0],
      viewedInVc[1],
      viewedInVc[2],
