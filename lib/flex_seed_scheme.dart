...
/// Non-deprecated versions of 8-bit color channel getters for `Color` as
/// well as its 32-bit value getter.
///
/// The getters are implemented the same way as the deprecated getters are
/// in `Color`, but these are not deprecated and they are called
/// `value32bit`, `alpha8bit`, `red8bit`, `green8bit`, `blue8bit`.
/// These getters will not be deprecated anytime soon.
...
/// ColorScheme. Six tonal palettes are generated, where the error palette
/// defaults to the Material-3 hue 25, chroma 84 palette, if no error seed
/// color is provided.
///
...
///
/// To get even more tones you can use `FlexPaletteType.extended`, which adds
/// the tones 2,4,6,12,17,22,24,65,75,84,87,92,94,96,97 for a
/// total of 30 tones, which are
